<template>
  <div class="layout">
    ...
    <Hero title="Limfjord Camping" text="Jeg designer og udvikler små og store hjemmesider hvor både design, CMS og performance understøtter målsætningerne og brugernes adfærd." image="/_nuxt/assets/images/case-test-img.jpg" />
...
import CasesInfo from '~/components/cases/CasesInfo.vue'

export default {
  metaInfo: {
    title: 'Limfjord camping'
  },
...
.layout{  
  @extend .page.cases-limfjords-camping;
}
